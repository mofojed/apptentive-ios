Pod::Spec.new do |s|
  ...
  s.ios.resource_bundle = { 'ApptentiveResources' => ['ApptentiveConnect/source/Model/*.xcdatamodeld', 'ApptentiveConnect/source/**/*.storyboard', 'ApptentiveConnect/source/Engagement/Interactions/Upgrade Message/ATInteractionUpgradeMessageViewController.xib', 'ApptentiveConnect/resources/localization/*.lproj', 'ApptentiveConnect/resources/Images.xcassets', 'ApptentiveConnect/resources/images/**/*.*', 'ApptentiveConnect/resources/CocoaPodsResources/Info.plist'] }
